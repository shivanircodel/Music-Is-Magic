...
function keyPressed(t) {
	...
	"1" == i && exportRoot.left_drum.gotoAndPlay(0), "2" == i && exportRoot.right_drum.gotoAndPlay(0)
}! function(t, i, e) {
	var n;
	(t.bongos = function() {
		this.initialize(),
			this.left_drum = new t.ridebutton,
			this.left_drum.setTransform(110, 40.3, .92, .91),
			new e.ButtonHelper(this.left_drum, 0, 1, 2, !1, new t.ridebutton, 3),
...
function initAudio() {
	var audio = new Audio('musical_instruments/piano/sounds/a01wav.mp3');
	var self = this;
...
function init() {
	...
	var manifest = [{
		...
		src: "bongos_sounds/_1awav.mp3",
		id: "_1awav"
	}, {
		src: "bongos_sounds/_1bwav.mp3",
		id: "_1bwav"
	}];
